      ...
      <div className="hidden md:flex md:w-1/2 bg-slate-900 relative p-16 flex-col justify-between overflow-hidden">
         ...
         <div className="relative z-10">
            <div className="flex items-center gap-3 mb-12">
               ...
               <span className="text-xl font-black text-white uppercase tracking-tighter">Allied Surplus <span className="text-emerald-500">Admin</span></span>
            </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="h-12 bg-white border-slate-200 rounded-2xl focus-visible:ring-emerald-500/20 font-bold text-sm tracking-tight placeholder:italic placeholder:font-normal"
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="h-12 bg-white border-slate-200 rounded-2xl focus-visible:ring-emerald-500/20 font-bold text-sm tracking-tight placeholder:italic"
                placeholder="••••••••"
              />
            </div>
