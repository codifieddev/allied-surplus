        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-xl font-black text-white uppercase tracking-tighter">
              Allied Surplus <span className="text-emerald-500">Login</span>
            </span>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <button
                  type="button"
                  className="text-[9px] font-black uppercase tracking-widest text-slate-300 hover:text-emerald-600 transition-colors"
                >
                  Request Reset
                </button>
              </div>
          ...
          <div className="mt-12 flex flex-col items-center gap-4 text-center">
            <div className="flex items-center gap-2 p-2 rounded-xl bg-slate-100 border border-slate-200 opacity-50">
              ...
              <span className="text-[9px] font-black uppercase tracking-widest text-slate-500">
                Biometric Verification Backup Enabled
              </span>
            </div>
