  ...
  return (
    <div className="bg-charcoal border border-white/5 rounded-sm p-6 space-y-6 shadow-2xl shadow-black/40 relative overflow-hidden group">
      ...
      <div className="flex items-center gap-3 border-l-2 border-gold pl-4">
        ...
        <h3 className="text-sm font-black text-white uppercase tracking-[0.2em]">General Intel</h3>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black text-white/40 uppercase tracking-widest flex items-center gap-2">
            <Type size={12} className="text-gold" /> Asset Designation
          </label>
          <input
            type="text"
            value={name}
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black text-white/40 uppercase tracking-widest flex items-center gap-2">
            <Terminal size={12} className="text-gold" /> Serial SKU
          </label>
          <input
            type="text"
            value={sku}
      ...
      {/* Description */}
      <div className="space-y-2">
        <label className="text-[10px] font-black text-white/40 uppercase tracking-widest">Technical Brief briefing</label>
        <textarea
          value={description}
