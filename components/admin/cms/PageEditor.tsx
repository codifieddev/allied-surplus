...
export const PageEditor: React.FC<PageEditorProps> = ({
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      {/* Tactical Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b-2 border-charcoal pb-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-3xl font-black text-white uppercase tracking-[0.2em]">
                {initialData ? "Refine" : "Forge"}{" "}
                <span className="text-gold">Objective</span>
              </h1>
            </div>
      ...
      <Tabs defaultValue="content" className="w-full">
        ...
        <TabsContent value="content" className="space-y-6 outline-none">
          <div className="bg-charcoal border border-charcoal-light p-6 shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="space-y-2">
                    {activeLanguages.map((lang) => (
                      <div key={lang.code} className="relative">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[9px] font-black text-gold/30 uppercase">
                          {lang.code}
                        </span>
                        <Input
                          placeholder={`e.g. OPERATIONS COMMAND (${lang.name})`}
                          ...
                          className="h-10 bg-ink border-charcoal-light rounded-none text-white font-black uppercase tracking-widest focus:border-gold transition-all pl-12"
                        />
                      </div>
                    ))}
                  </div>
              ...
              <div className="h-80 border-2 border-dashed border-charcoal-light bg-charcoal/30 flex flex-col items-center justify-center text-slate-600 gap-6">
                ...
                <div className="text-center">
                  <p className="text-xs font-black uppercase tracking-[0.3em] mb-2">
                    Interface Workspace Vacant
                  </p>
                  <p className="text-[10px] font-bold uppercase tracking-widest opacity-50">
                    Initiate architecture sequence to begin forge.
                  </p>
                </div>
                <Button
                  variant="outline"
          ...
          <div className="bg-charcoal-dark border border-charcoal-light p-6 flex flex-col md:flex-row items-center gap-6 opacity-80">
            <div className="flex-1 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex gap-4">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500 leading-relaxed">
                    Insert **Tactical Assets** (Text, Imagery) within sector
                    grids.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-2">
                  {activeLanguages.map((lang) => (
                    <div key={lang.code} className="relative">
                      ...
                      <Input
                        placeholder={`Objective designation for web crawlers (${lang.name})`}
                        ...
                        className="bg-ink border-charcoal-light rounded-none text-white font-bold focus:border-gold h-12 pl-12"
                      />
                    </div>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {activeLanguages.map((lang) => (
                    <div key={lang.code} className="relative">
                      <span className="absolute left-3 top-3 text-[9px] font-black text-gold/30 uppercase">
                        {lang.code}
                      </span>
                      <Textarea
                        placeholder={`Operational summary for network indexing (${lang.name})`}
                        ...
                        className="bg-ink border-charcoal-light rounded-none text-white font-bold focus:border-gold min-h-[100px] p-4 pl-12"
                      />
                    </div>
                  ))}
                </div>
